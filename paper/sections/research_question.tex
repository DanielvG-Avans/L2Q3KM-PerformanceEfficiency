...
\begin{enumerate}
	...
	\item How do selected browser-side metrics, including LCP, FCP, TTFB, navigation response size, and the JavaScript heap sample, differ between SSR and CSR under the same conditions?
